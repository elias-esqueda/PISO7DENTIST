  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="pointer-events-none absolute right-16 hidden whitespace-nowrap rounded-full bg-ink-950 px-4 py-2 font-mono text-[10px] uppercase tracking-[0.15em] text-cream-50 opacity-0 shadow-lg transition-opacity duration-300 group-hover:opacity-100 sm:block">
          Escríbenos
        </span>
      </Link>
    </motion.div>
